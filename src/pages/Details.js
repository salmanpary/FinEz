...
function Details() {
    ...
    return (
        <div>
            ...
            <div className="box_3d m-10 flex justify-between lg:mx-52 bg-gray-100 p-7 rounded-lg items-center">
                <div className="flex ">
            ...
            <fieldset className='border-4 w-[24rem] ml-[15rem] mt-12 p-4 border-blue-800 rounded-2xl'>
            ...
            <div className="flex ml-[15rem] mt-12">
                <div className="">
                    ...
                    <p className='max-w-[75ch] mt-5 ml-0'>The scheme invests in the higher market cap coins Bitcoin and Ethereum</p>
                </div>
                <div className="ml-32">
