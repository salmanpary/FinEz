...
{follow?<button onClick={()=>setFollow(false)} className="font-bold mb-2 py-2 px-8 rounded-3xl bg-blue-700 hover:bg-blue-500 text-xs text-white flex items-center justify-center">Follow</button>:<div className="flex flex-col">
